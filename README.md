...
Проект по локализации игры Portals of Phereon на русский язык. Представляет из себя сборку из инжектора, плагина для перевода, пресета конфигураций и перевод.
...
<br/>Версия игры 0.20.0.1 
<br/>Версия инжектора BepInEx 5.4.19.0 x32 https://github.com/BepInEx/BepInEx
<br/>Версия XUnity.AutoTranslator 5.1.0 https://github.com/bbepis/XUnity.AutoTranslator
...
По поводу проблем с переводчиком писать сюда в раздел Issues или мне приват в дискорде. Не пишите в основной дискорд порталов т.к. Syvaron не имеет никакого отношения конкретно к этом моду. Найти меня можно через основной сервер по нику BreadDain, прямую ссылку на профиль оставлять не буду.
...
~~Поддержать проект перевода: https://www.patreon.com/BreadDain~~ бесполезно, санкции. Если кто-либо когда то захочет скинуть мне на пиво - то прямым переводом, пишите в дискорд.
...
3) Изменить масштаб элементов интерфейса, где текст выходит за пределы и/или исчезает вовсе. -задача заморожена до поступления репортов и проявления интереса в моде.
4) Ручной перевод - Если у меня появится стимул это делать.
